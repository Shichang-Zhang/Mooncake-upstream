...
// TE mode: last arg sets te_async_poll_worker_num=18; memcpy positional 5 only applies in MEMCPY mode (default 32).
...
// MEMCPY mode: memcpy positional 5 and last-arg te_async_poll_worker_num=99 both apply.
